            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    ...
                    <div class="customer-card"
                        ...
                        <form action="{{ URL::to('/change-password-customer') }}" method="post"
                            style="margin: 30px auto; padding: 20px; border-radius: 8px; background: #fff;">
                            {{ csrf_field() }}
                            <div style="margin-bottom: 15px;">
                                <label style="display: block; margin-bottom: 5px; font-weight: 600;">Mật khẩu hiện tại
                            ...
                            <div style="margin-bottom: 15px;">
                                <label style="display: block; margin-bottom: 5px; font-weight: 600;">Mật khẩu mới <span
                            ...
                            <div style="margin-bottom: 20px;">
                                <label style="display: block; margin-bottom: 5px; font-weight: 600;">Xác nhận mật khẩu
