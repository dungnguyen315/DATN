                    ...
                    <div class="customer-card"
                        ...
                        <div class="row" style="margin-bottom: 20px;">
                            <div class="col-md-6" style="margin-bottom: 15px;">
                                ...
                                <p style="margin: 0 0 10px;">
                                    {{ $info_shipping->shipping_email ?? 'Khách hàng chưa đăng ký thông tin.' }}</p>

                                <p style="margin: 0; font-weight: bold;">Số điện thoại:</p>
                                <p style="margin: 0;">
                                    {{ $info_shipping->shipping_phone ?? 'Khách hàng chưa đăng ký thông tin.' }}</p>
                            </div>

                            <div class="col-md-6" style="margin-bottom: 15px;">
                                <p style="margin: 0; font-weight: bold;">Địa chỉ giao hàng:</p>
                                <p style="margin: 0 0 10px;">
                                    {{ $info_shipping->shipping_address ?? 'Khách hàng chưa đăng ký thông tin.' }}</p>

                                <p style="margin: 0; font-weight: bold;">Ngày tạo tài khoản:</p>
                                <p style="margin: 0;">
                                    {{ date('d/m/Y', strtotime($info_shipping->customer->created_at ?? now())) }}</p>
                            </div>
                        </div>
