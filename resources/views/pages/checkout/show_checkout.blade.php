        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="background:none;">
                    ...
                    <li class="breadcrumb-item active" style="border:none;" aria-current="page">Điền thông tin giao
                        hàng</li>
                </ol>
            </nav>
                            ...
                            <form action="{{ URL::to('/save-checkout-customer') }}" method="post">
                                ...
                                <div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="shipping_name" class="form-control"
                                                placeholder="Họ tên" value="{{ old('shipping_name') }}">
                                        </div>

                                        <div class="form-group">
                                            <input type="text" name="shipping_address" class="form-control"
                                                placeholder="Địa chỉ" value="{{ old('shipping_address') }}">
                                        </div>

                                        <div class="form-group">
                                            <input type="text" name="shipping_phone" class="form-control"
                                                placeholder="Số điện thoại" value="{{ old('shipping_phone') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block">Tiếp tục thanh
                                            toán</button>
...
<script>
    document.getElementById("checkoutForm").addEventListener("submit", function(event) {
        ...
        if (phone && !phoneRegex.test(phone)) {
            document.getElementById("shipping_phone").nextElementSibling.innerHTML =
