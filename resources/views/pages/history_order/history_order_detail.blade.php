        ...
        <div class="container mb-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb" style="background:none;">
                    ...
                    <li class="breadcrumb-item active" style="border:none;" aria-current="page">Chi tiết đơn hàng
                    </li>
                </ol>
            </nav>
            @foreach ($all_order as $order => $data_order)
                <div class="order-detail-card p-4">
                    ...
                    <div class="order-meta mb-4">
                        <p><strong>Ngày đặt: {{ date('m/d/Y', strtotime($data_order->first()->order_date)) }}</strong>
                        </p>
                    ...
                    <div class="text-right mt-3">
                        ...
                        <p><strong>Phí vận chuyển:</strong>
                            {{ number_format($data_order->first()->fee_ship ?? 0, 0, ',', '.') }} VNĐ</p>
                        <p><strong>Giảm giá: </strong>
                            {{ number_format($data_order->first()->product_counpon_percent ?? 0, 0, ',', '.') }} VNĐ
                        </p>
                        <hr style="border-top: 1px dashed #ccc;">
                        <p style="font-size: 16px; font-weight: bold; color: #e74c3c;">Tổng thanh toán:
                            {{ number_format($total_payment, 0, ',', '.') }} VNĐ</p>
                    </div>
                </div>
            @endforeach
        </div>
