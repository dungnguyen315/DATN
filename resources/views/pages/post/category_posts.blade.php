...
<body>
    ...
    <section>
        <div class="container">
            ...
            padding-bottom: 10px;
        ">
                                        <img src="{{ URL::to('upload/post/' . $post->post_image) }}"
                                            alt="{{ $post->post_slug }}"
                                            style="
                width: 90px;
                height: 65px;
            ...
            ">
                                        ...
                                        <div style="flex: 1;">
                                            ...
                                            <p
                                                style="font-size: 13px; color: #666; margin: 0 0 8px 0; line-height: 1.5;">
                ...
                <div class="col-sm-9 padding-right">
                    <div class="features_items"><!--features_items-->
                        @if ($cate_post_name && $cate_post_name->cate_post_status == 1)
                            <h2 style="margin-top:5px;" class="title text-center">Danh mục tin tức
                                {{ $cate_post_name->cate_post_name }}</h2>
                        @endif
                        <div class="product-image-wrapper">
                            @foreach ($posts as $key => $val)
                                <div class="single-products"
                                    style="margin: 15px 0; padding: 15px; border: 1px solid #e0e0e0; border-radius: 8px; background-color: #fff; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
                                    <div style="display: flex; align-items: flex-start;">
                                        <img src="{{ URL::to('upload/post/' . $val->post_image) }}"
                                            alt="{{ $val->post_slug }}"
                                            style="width: 30%; max-width: 150px; height: auto; border-radius: 5px; margin-right: 15px;" />
                                        <div style="flex: 1;">
                                            <h4 style="margin-top: 0; font-size: 18px; color: #333;">
                                                {{ $val->post_title }}</h4>
